...
/**
 * Creates a barrier after which we are guaranteed that all writes performed by the previous primary
 * have been majority commited and will be seen by the new primary.
 */
